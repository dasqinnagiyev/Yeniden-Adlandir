...
async def ForceSub(bot: Client, event: Message):
    """
    Custom Pyrogram Based Telegram Bot's Force Subscribe Function by @dasqinnagiyev.
    ...
    try:
        ...
        print(f" {Config.UPDATES_CHANNEL} kanalına abunə olmağı mümkün deyil\n\nXəta: {err}\n\nDəstəklə əlaqəyə keç: https://t.me/idaqobot")
        return 200
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Bağışla, Məni istifadə edə bilməzsiniz. Dəstəklə [Əlaqəyə keç](https://t.me/idaqobot).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=event.from_user.id,
            text="**Botu işlədə bilmək üçün kanalıma gəlməlisən!**\n\nHədindən artıq yüklənmə səbəbindən, yalnız kanal abunəçiləri bu botdan istifadə edə bilərlər!",
        ...
        print(f"Birşeylər tərs getdi! Abunəlik mümkün deyil.\nXəta: {err}\n\nDəstəklə əlaqəyə keç: https://t.me/idaqobot")
        return 200
